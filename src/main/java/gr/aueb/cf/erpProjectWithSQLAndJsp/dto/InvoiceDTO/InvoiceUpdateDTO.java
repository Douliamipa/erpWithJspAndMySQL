...
public class InvoiceUpdateDTO extends Base {
    ...
    public InvoiceUpdateDTO(String invoiceNo, Client client, Date date, String vatStatus, String paymentMethod, String vatExemption, double amount, double vatPercentage, double totalAmount) {
