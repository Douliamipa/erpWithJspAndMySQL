...
public class SupplierDeleteDTO extends Base {
    ...
    public SupplierDeleteDTO(){}

    public SupplierDeleteDTO(int id,String companysName, long vatNo, String street, String streetNo, String city, int zipCode,
                             String country, String paymentMethod, String accountingCategory) {
        this.setId(id);
