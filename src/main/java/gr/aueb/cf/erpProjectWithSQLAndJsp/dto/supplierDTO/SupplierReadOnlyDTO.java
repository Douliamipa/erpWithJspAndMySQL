package gr.aueb.cf.erpProjectWithSQLAndJsp.dto.supplierDTO;

import gr.aueb.cf.erpProjectWithSQLAndJsp.dto.Base;

public class SupplierReadOnlyDTO extends Base {
    ...
    public SupplierReadOnlyDTO (){}

    public SupplierReadOnlyDTO(int id,String companysName, long vatNo, String street, String streetNo, String city,
                               int zipCode, String country, String paymentMethod, String accountingCategory) {
        this.setId(id);
