...
public class InvoiceReadOnlyDTO extends Base {
    ...
    public InvoiceReadOnlyDTO(){}

    public InvoiceReadOnlyDTO(String invoiceNo, Client client, Date date, String vatStatus, String paymentMethod, String vatExemption, double amount, double vatPercentage, double totalAmount) {
