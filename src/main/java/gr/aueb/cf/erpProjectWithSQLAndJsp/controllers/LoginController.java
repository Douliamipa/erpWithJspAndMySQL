...
import gr.aueb.cf.erpProjectWithSQLAndJsp.authentication.AuthenticationProvider;
...
public class LoginController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/frontPages/login.jsp").forward(request,response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (principleIsAuthenticated){
            ...
            response.sendRedirect(request.getContextPath()+"/erpProjectWithSQLAndJsp/mainMenu");
            //response.sendRedirect(request.getContextPath()+"/erpProjectWithSQLAndJsp/menu");
        }else {
